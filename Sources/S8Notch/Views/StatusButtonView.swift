...
/// mark flanked by the two counts (review-requested on the left, your PRs on
/// the right) — the tray echo of the notch's two icon clusters.
struct StatusButtonView: View {
    ...
    var body: some View {
        HStack(spacing: 3) {
            ...
            countBadge(state.myAttention.count)
        }
